...
import {
  getLaterHandler,
  addItemToLaterVideos,
  removeItemFromLateredVideos,
} from './backend/controllers/LaterController';
import {
...
export function makeServer({ environment = 'development' } = {}) {
  return new Server({
    ...
    routes() {
      ...
      // video route (private)
      this.post('/video/:videoId', updateVideoHandler.bind(this));
      ...
      this.get('/user/laters', getLaterHandler.bind(this));
      this.post('/user/laters', addItemToLaterVideos.bind(this));
      this.delete(
        '/user/laters/:videoId',
        removeItemFromLateredVideos.bind(this)
      );
